package com.maywide.liveshow.Handler;
...
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_AUDIO_ROUTE;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_AUDIO_VOLUME_INDICATION;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_CONNECTLOST;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_ENTER_ROOM;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_ERROR;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_LOCAL_AUDIO_STATE;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_LOCAL_VIDEO_STATE;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_MUTE_AUDIO;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_REMOTE_AUDIO_STATE;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_REMOTE_VIDEO_STATE;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_REMOVE_FIRST_FRAME_COME;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_SEI;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_SPEAK_MUTE_AUDIO;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_USER_JOIN;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_USER_MUTE_VIDEO;
import static com.maywide.liveshow.LocalConstans.CALL_BACK_ON_USER_OFFLINE;
...
public class MyTTTRtcEngineEventHandler extends TTTRtcEngineEventHandler {
    ...
    public void onUserKicked(long uid, int reason) {
        Log.i("wzg", "onUserKicked.... uid ： " + uid + "reason : " + reason + "mIsSaveCallBack : " + mIsSaveCallBack);
        JniObjs mJniObjs = new JniObjs();
    ...
    public void onReconnectServerFailed() {
        Log.i("wzg", "onReconnectServerFailed.... ");
        JniObjs mJniObjs = new JniObjs();
    ...
    public void onUserEnableVideo(long uid, boolean enabled) {
        Log.i("wzg", "onUserEnableVideo.... uid : " + uid + " | enabled : " + enabled);
        JniObjs mJniObjs = new JniObjs();
    ...
    public void onClientRoleChanged(long uid, int userRole) {
        ...
        Log.i("wzg", "onUserRoleChanged... userID : " + uid + " userRole : " + userRole);
        JniObjs mJniObjs = new JniObjs();
    ...
    public void onUserMuteAudio(long uid, boolean muted) {
        Log.i("wzg", "OnRemoteAudioMuted.... uid : " + uid + " | muted : " + muted + " | mIsSaveCallBack : " + mIsSaveCallBack);
        JniObjs mJniObjs = new JniObjs();
    ...
    public void onSpeakingMuted(long uid, boolean muted) {
        Log.i("wzg", "onSpeakingMuted.... uid : " + uid + " | muted : " + muted + " | mIsSaveCallBack : " + mIsSaveCallBack);
        JniObjs mJniObjs = new JniObjs();
