package com.maywide.liveshow.net.retrofit.cookie;


import android.util.Log;


import com.maywide.liveshow.net.retrofit.cookie.store.CookieStore;
...
public class CookieJarImpl implements CookieJar {
    ...
    public synchronized void saveFromResponse(HttpUrl url, List<Cookie> cookies) {
        ...
        Log.e("cookies", "saveFromResponse: "+cookies.size());
    }
