...
//        activity.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    public static void setStatusWhite(Activity activity, View view) {
        View statuBarWhite = view.findViewById(R.id.view_status_bar);
        if (view == null) {
            return;
        }
    ...
    public static void setStatusDark(Activity activity, View view) {
        ...
        View statuBar = view.findViewById(R.id.view_status_bar);
        if (statuBar != null) {
     ...
     */
    public static int statusBarWhite(Activity activity) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
     ...
     * @return 1:MIUUI 2:Flyme 3:android6.0
     */
    public static int statusBarWhiteChatActivity(Activity activity) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightModeChatActivity(activity, true)) {
                result = 1;
            } else if (FlymeSetStatusBarLightMode(activity.getWindow(), true)) {
                result = 2;
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
     ...
     * @return boolean 成功执行返回true
     */
    private static boolean MIUISetStatusBarLightModeChatActivity(Activity activity, boolean dark) {
        boolean result = false;
        Window window = activity.getWindow();
        if (window != null) {
            Class clazz = window.getClass();
