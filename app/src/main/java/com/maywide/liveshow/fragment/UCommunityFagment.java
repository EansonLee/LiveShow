 ...
 * U互动社区
 */
public class UCommunityFagment extends BaseFragment {
    ...
    public static UCommunityFagment newInstance() {
        UCommunityFagment fragment = new UCommunityFagment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_ucommunity;
    }

    @Override
    protected void initView() {
        tvTitle.setText(R.string.ucommunity_title);
    ...
    private void newsReq(final int pageIndex, int pageSize) {
        ...
        homeNewsReq.setMobile(BaseAcitivity.mobile);
